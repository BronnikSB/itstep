...
# print(myList)
#-----------------------------------------------
# Выдали даме на станции четыре зелёных квитанции о том, что получен багаж:
# диван, чемодан, Саквояж, картина, корзина, картонка и маленькая собачонка.
# Вещи везут на перрон.
# Кидают в открытый вагон. Готово.
# Уложен багаж: Диван, чемодан, саквояж, картина, корзина, картонка и маленькая собачонка.
#------------------------------------------------
